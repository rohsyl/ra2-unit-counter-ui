...
onMounted(() => {
  wsConnection = new WebSocket(import.meta.env.VITE_WS_URL + '?type=master')
  wsConnection.onopen = () => {
  ...
  <div class="p-2">
    ...
    <Card>
      ...
      <p class="mb-2">
        ...
        <router-link to="/settings" class="text-blue-700 underline hover:text-blue-400">configure units</router-link>
      </p>
      <h4 class="text-xl font-bold mb-2 border-b">
        Allied units
        <img src="/assets/factions/allied.webp" alt="Allied" class="inline-block h-6 mb-1" />
      </h4>
      <CheckedUnitPreview :units="getCheckedAlliedUnits" :color="ColorsProvider.getColor('blue')" class="mb-4" />
      <h4 class="text-xl font-bold mb-2 border-b">
        Soviet units
        <img src="/assets/factions/soviet.webp" alt="Allied" class="inline-block h-6 mb-1" />
      </h4>
